...
function startCreateChoreGroup() {
  ...
  */
  ...
  function addCustomChore(evt) {
    ...
    if(customChore != "") {
      addChoreToUserList(customChore); 
    }
  ...
  */
  ...
  function createChoreForms(){
    ...
    var masterDate = document.getElementById("masterDate");
    masterDate.min = todaysDate;
    /*
    ...
    */
    ...
    //3. INDEX 
    var form4 = "' name='' class='choreOptionForm'>Due Date <input type='date' id='choreDate";
    //5. INDEX
    var form6 = "' name='' min='";
    //7. TODAYS DATE
  ...
  function checkForms(evt) {
    ...
    for(let x = 0; x < choreArray.length; x++){
      ...
      if(document.getElementById("masterDate").value == ""){
        if(dueDate.value == ""){
            allGood = false;
  ...
  */
  ...
  function makeChores() {
    ...
    for(i = 0; i < choreArray.length; i++){
      ...
      if(document.getElementById("masterDate").value != "" && 
         document.getElementById("choreDate" + i).value == "")
      {
        chore.date = document.getElementById("masterDate").value;
      }
      else{
  ...
  */
  ...
  function displayChoreAssignments() {
    ...
    */
    ...
    var html3 ="</div>";
            //Rating
    var html5 = "<div class='choreDueCompleted'><div class='choreItem'>";
            //Chore
    var html7 = "</div><div class='dueItem'> Due On ";
            //Due Date
    var html9 = "</div>";
            //email
    var htmlPart3= "</div></div></div>";
    var x = 0;
    for(x = 0; x < actorsArray.length; x++){
      ...
      for(i = 0; i < choreArray.length; i++){
        if(choreArray[i].assigned == actorName){
          counter++;
          let date = choreArray[i].date;
          date = date.toString();
          date = date.replace("2019-", "");
          date = date.replace("-","/");
          htmlPart2 += html5 + choreArray[i].name + html7 + " - " + date + html9;
        }
      }
      if(counter == 0){
        htmlPart2 = html5 + "No Chores" + "</div>";
      }
  ...
  */
  ...
  function processEmailPython(evt){
    ...
    */
    ...
    httpRequest.open("GET","sendEmail.py?text=" + emailJson);
    ...
    //window.location = "python/sendEmail.py?x=emailJson"; 
...
addLoadEvent(showAndHideNavBar);
//addLoadEvent();
//addLoadEvent();
